...
public class Image {
    ...
    @ManyToMany(fetch = FetchType.EAGER)                   //Fix for exception encountered while performing LAZY Loading by the system.
    private List<Tag> tags = new ArrayList<>();

    @OneToMany(fetch = FetchType.EAGER)
    @Fetch(value = FetchMode.SUBSELECT)                    //Fix for exception encountered : "org.hibernate.loader.MultipleBagFetchException: cannot simultaneously fetch multiple bags:"
    private List<Comments> comments = new ArrayList<>();   //Functionality Upgrade: Users can add comments for any image.
    ...
    //Functionality Upgrade: Users can add comments for any image.
