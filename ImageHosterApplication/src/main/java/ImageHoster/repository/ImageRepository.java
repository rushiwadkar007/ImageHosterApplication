...
public class ImageRepository {
    ...
    public Image getImageByTitle(String title,int id) {
        EntityManager em = emf.createEntityManager();
        TypedQuery<Image> typedQuery = null; //Fix for image upload issue.
        try {
            //typedQuery = (TypedQuery<Image>) em.createQuery("SELECT i from Image i where i.title =:title , Image.class)setParameter("title",title); ;//Fix for image upload issue.
            typedQuery = (TypedQuery<Image>) em.createQuery("SELECT i from Image i where i.title =:title and i.id =:id", Image.class); //Fix for image upload issue.
